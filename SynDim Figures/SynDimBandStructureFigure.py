...
#make figure
plt.close(1)
fig2 = plt.figure(1,figsize=(6.2,4.0))
gs = gridspec.GridSpec(2,10)
gs.update(left=0.15, right=0.85, top=0.85, bottom = 0.15,hspace = 0.2,wspace=4.5)
...
panel=fig2.add_subplot(gs[1,0:4])
...
cbar_axes = fig2.add_subplot(gs[:,4])
...
cbar_axes = fig2.add_subplot(gs[:,9])
