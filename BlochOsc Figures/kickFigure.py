...
pan.set_ylim(-1.05,0.0)

shift = 0.8
ylist2 = gaussian(xlist,1.0,-1.0,shift,0.0)
pan=fig.add_subplot(gs[0,1])
pan.plot(xlist,ylist2,'b-')
xTanList = np.linspace(-1.0,1.0,num=100)
yTanList = tangent(xTanList,1.0,-1.0,shift,0.0,0.0)
pan.plot(0.0,gaussian(0.0,1.0,-1.0,shift,0.0), 'ko', markersize=8 )
pan.plot(xTanList,yTanList,'k--',linewidth=1)
pan.set_xticks([])
pan.set_yticks([])
