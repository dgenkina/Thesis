...
#pan.axvline(x=1.0,c='k')
#pan.axvline(x=-1.0,c='k')
#
#plt.savefig('../Chapter4 Figures/figure1.pdf', transparent=True)
...
fig2 = plt.figure(1,figsize=(6.2,6.0))
gs = gridspec.GridSpec(4,3)
gs.update(left=0.15, right=0.85, top=0.85, bottom = 0.15,hspace = 0.5)
...
pan.set_xlabel(r'$q/k_L$')
pan.set_title('(d)')
plt.savefig('../Chapter4 Figures/figure2.pdf', transparent=True)    
