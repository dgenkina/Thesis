...
At the time of writing, the \K{} part of the apparatus as described is no longer functional. The number of \K{} atoms collected in the MOT has started decaying significantly in January 2014, and by March was almost compeltely gone and could not be resurrected. The specific failure point of the setup was not clear. However, other groups have found that \K{} sources are much more stable, and a higher fraction of the (expensive) \K{} sources was utilized when the atoms were initially cooled with a 2-D MOT rather than a Zeeman slower.  